import pandas as pd
import numpy as np
from .base import EstadisticaBase  # [C1] Importación CLAVE para la Herencia

class DatosCualitativos(EstadisticaBase):
    """
    Clase para analizar variables cualitativas (categóricas).
    [C16 Docstring] Hereda de EstadisticaBase y aplica Polimorfismo.
    """

    def __init__(self, ruta_archivo, columna, separador=';'):
        """
        [C10 Init] Inicializa la clase leyendo el archivo CSV y seleccionando la columna.
